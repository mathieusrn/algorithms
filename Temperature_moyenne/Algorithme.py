...
# Chargement du fichier csv relatif au code régions
df = pd.read_csv('code_insee_regions.csv', sep=';', header=None)

# Suppression des doublons
df_unique = df.drop_duplicates()

# Création d'un dictionnaire où les codes de région sont les clés et les noms de région sont les valeurs
region_dict = pd.Series(df_unique[1].values,index=df_unique[0]).to_dict()

# Transformation du dictionnaire en une liste de tuples et division de la liste en 5 parties
...
# Création de 5 labels pour afficher les régions
